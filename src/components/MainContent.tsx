    ...
    <div className={styles.mainContent}>
      ...
      <main className={styles.content}>
        <div className={styles.greeting}>
          ...
          <p>Continúa tu camino de aprendizaje donde lo dejaste</p>
        </div>
        ...
        <div className={styles.courseCard}>
          ...
          <div className={styles.courseInfo}>
            ...
            <p>Domina los conceptos básicos de JavaScript y construye aplicaciones web modernas</p>
            <div className={styles.progressSection}>
              <div className={styles.progressCircle}>
                <svg className={styles.progressRing} width="120" height="120">
                  <circle cx="60" cy="60" r="50" fill="none" stroke="#333333" strokeWidth="8"/>
                  <circle cx="60" cy="60" r="50" fill="none" stroke="url(#gradient)" strokeWidth="8" 
                          strokeDasharray="314" strokeDashoffset="150" strokeLinecap="round"/>
                  <defs>
          ...
          <div className={styles.courseActions}>
            <div className={styles.nextClass}>
              <div className={styles.nextClassInfo}>
                <span className={styles.nextClassLabel}>🎉 ¡Estás al día!</span>
                <span className={styles.nextClassDate}>Próxima clase: 06 de Agosto, 2025</span>
              </div>
        ...
        <div className={styles.sectionsGrid}>
          <div className={styles.learningPath}>
            ...
            <p>Cursos personalizados para alcanzar tus metas profesionales</p>
